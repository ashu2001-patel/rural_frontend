...
const MyListings = () => {
  ...
  const currentList =
    tab === "animals" ? animals : tab === "tools" ? tools : plants;

  const currentType =
    tab === "animals" ? "animal" : tab === "tools" ? "tool" : "plant";

  const getDetailPath = (type, id) =>
    `/${type === "animal" ? "animal" : type === "tool" ? "tool" : "plant"}/${id}`;
  ...
  return (
    <>
      <style>{`
        ...
        .ml-tab:hover {
          border-color: rgba(212,175,99,0.25);
          color: rgba(212,175,99,0.7);
        }

        .ml-tab.active {
          background: rgba(212,175,99,0.1);
          border-color: rgba(212,175,99,0.35);
          color: #d4af63;
        }
        ...
        .ml-spinner {
          width: 36px;
          height: 36px;
          border: 2px solid rgba(212,175,99,0.15);
          border-top-color: #d4af63;
          border-radius: 50%;
        ...
        {loading ? (
          ...
          <div className="ml-empty">
            ...
            <button
              ...
              onClick={() => navigate(getPostPath(currentType))}
            >
              ...
              {currentList.map((item) => (
                <div key={item._id} className="ml-card">
                  <img
                    ...
                    onError={(e) => {
                      e.currentTarget.src = "https://via.placeholder.com/280x160?text=No+Image";
                    }}
                  />
                  ...
                  <div className="ml-card-body">
                    ...
                    <div className="ml-card-actions">
                      <button
                        ...
                        onClick={() => navigate(getDetailPath(currentType, item._id))}
                      >
                        👁 View
                      </button>
